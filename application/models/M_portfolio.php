...
class M_portfolio extends CI_Model
{
  public function daftar()
  {
    ...
    $this->db->join('tb_user', 'tb_user.id_user = portfolio.id_user', 'left');
    $this->db->join('tb_client', 'tb_client.id_client = portfolio.id_client', 'left');
    $this->db->join('tb_layanan', 'tb_layanan.judul_layanan = portfolio.nama_layanan', 'left');
  ...
  {
    $this->db->where('id_portfolio', $data['id_portfolio']);
    $this->db->delete('portfolio', $data); // FLASH DATA
